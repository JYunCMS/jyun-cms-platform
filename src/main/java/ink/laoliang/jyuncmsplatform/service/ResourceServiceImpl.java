...
public class ResourceServiceImpl implements ResourceService {
    ...
    public Resource upload(MultipartFile file) {
        ...
        String storageFilename = now.getTimeInMillis() + originalFilename.substring(originalFilename.lastIndexOf('.'));
        ...
        // 存库，数据库标识
        return resourceRepository.save(new Resource(targetFilePath.toString().replace('\\', '/'), originalFilename, storageFilename, 0));
    }
}
